...
const Payment = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data: order } = await axios.post(`https://flipkart-ru60.onrender.com/api/v1/payment/process`, paymentData);
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            let paymentResponse = await axios.post(`https://flipkart-ru60.onrender.com/api/v1/callback`, paymentResult);
